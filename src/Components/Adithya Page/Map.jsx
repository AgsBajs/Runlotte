...
const Map = () => {
  ...
  useEffect(() => {
    ...
    setDebugInfo('Mapbox token successfully loaded');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6 text-center">Route Planner</h1>
          ...
          <form onSubmit={handleLocationSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="City name or coordinates (e.g., -73.935242,40.730610)"
